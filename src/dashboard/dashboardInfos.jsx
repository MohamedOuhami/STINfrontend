        ...
        <Row>
          ...
          <Col lg={4}>
            <Card className="card">
              ...
              <Card.Body className="card-number">{patients.length}</Card.Body>
            </Card>
          </Col>
          <Col lg={4}>
            <Card className="card">
              <Card.Header className="head">DOCTORS</Card.Header>
              <Card.Body className="card-number">{medecins.length}</Card.Body>
            </Card>
          </Col>
        </Row>
        <Row style={{ marginTop: "10px" }}>
          <Col lg={6}>
            <Card className="card">
              ...
              <Card.Body className="card-number">{rdvs.length}</Card.Body>
            </Card>
          </Col>
          <Col lg={6}>
            <Card className="card">
              <Card.Header className="head">DISEASE</Card.Header>
              <Card.Body className="card-number">{maladies.length}</Card.Body>
            </Card>
          </Col>
        </Row>
      </Container> */}
